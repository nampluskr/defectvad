...
class Draem(BaseModel):
    def __init__(self, enable_sspcab=False):
...
class DraemTrainer(BaseTrainer):
    def __init__(self, model, enable_sspcab=False, sspcab_lambda=0.1, beta=(0.1, 1.0)):
        if not isinstance(model, Draem):
