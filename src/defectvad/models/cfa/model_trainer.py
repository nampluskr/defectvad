# src/defectvad/models/cfa/model_trainer.py
...
class CfaTrainer(BaseTrainer):
    def __init__(self, model, num_nearest_neighbors=3, num_hard_negative_features=3, radius=1e-5):
        if not isinstance(model, Cfa):
